...
class ConsultaService { // CLASSE PARA TRABALHAR O MONGOOSE
    ...
    async Create(name, email, description, cpf, date, time){ // TRABALANDO O CREATE DO MONGO
    ...
    async GetAll(showFineshed){ // PEGANDO TODAS AS INFORMAÇÕES DE PACIENTES NO PARAMETRO (FALSE, TRUE)
